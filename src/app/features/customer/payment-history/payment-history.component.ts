    ...
    <div class="page-wrapper">
      <div class="container">
        <div class="mb-4">
          ...
          <h1 class="page-title text-white mb-1">Payment History</h1>
              ...
              <table class="custom-table">
                ...
                <tbody>
                  @for (pay of payments(); track pay.paymentId) {
                    <tr>
                      <td>#{{ pay.paymentId }}</td>
                      <td><strong class="font-mono text-white">{{ pay.receiptNumber }}</strong></td>
                      <td>#{{ pay.bookingId }}</td>
...
export const PaymentsComponent = PaymentHistoryComponent;
export type PaymentsComponent = PaymentHistoryComponent;
