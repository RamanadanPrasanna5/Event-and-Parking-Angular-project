...
import { DashboardMetricsDto } from '../../../core/models/dashboard.model';
    ...
    <div>
      ...
      @if (loading()) {
        ...
        <div class="grid grid-cols-3 gap-4 mb-5">
          <app-stat-card
            label="Total Revenue"
            [value]="'LKR ' + ((metrics()?.totalRevenue || 0) | number)"
        ...
        <h3 class="mb-3 text-main">Management Shortcuts</h3>
        <div class="grid grid-cols-3 gap-3">
          <a routerLink="/admin/events" class="card card-hoverable p-3 d-flex align-items-center gap-3">
            ...
            <div>
              <h5 class="mb-1 text-main">Create New Event</h5>
              <small class="text-muted">Schedule date, venue & tickets</small>
            </div>
          </a>
          ...
          <a routerLink="/admin/seats" class="card card-hoverable p-3 d-flex align-items-center gap-3">
            ...
            <div>
              <h5 class="mb-1 text-main">Generate Seat Map</h5>
              <small class="text-muted">Configure rows & base ticket prices</small>
            </div>
          </a>
          ...
          <a routerLink="/admin/parking" class="card card-hoverable p-3 d-flex align-items-center gap-3">
            ...
            <div>
              <h5 class="mb-1 text-main">Setup Parking Layout</h5>
              <small class="text-muted">Define zones and bay fees</small>
            </div>
          </a>
        </div>
      }
