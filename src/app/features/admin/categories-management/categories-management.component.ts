...
import { CreateCategoryDto, EventCategory } from '../../../core/models/category.model';
            ...
            <table class="custom-table">
              ...
              <tbody>
                @for (c of categories(); track c.id) {
                  <tr>
                    <td><strong class="text-main">{{ c.name }}</strong></td>
                    <td class="text-muted">{{ c.description || 'No description' }}</td>
                    <td class="text-end">
                      <div class="d-flex justify-content-end gap-1">
                        <button class="btn btn-sm btn-secondary" (click)="openEditModal(c)" title="Edit">
                          <i class="fa-solid fa-pen-to-square me-1"></i> Edit
                        </button>
                        <button class="btn btn-sm btn-danger" (click)="promptDelete(c)" title="Delete">
        ...
        <div class="modal-overlay" (click)="closeOnBackdrop($event)">
          <div class="modal-container">
            <div class="modal-header">
              ...
              <button class="btn btn-icon btn-secondary" (click)="showModal = false">
